// java -cp "MySQL-JDBC\mysql-connector-java-8.0.12.jar;.;" MySQLSp
// OR
...
public class MySQLSp {
    public static void main(String args[]) {                
	    ...
	    stmt.setString(3, "@canceled");
	    stmt.setString(4, "@resolved");
	    stmt.setString(5, "@disputed");   
	    stmt.executeUpdate();	
            String shipped = stmt.getString(2);
	    System.out.println("@shipped = " + shipped);
            String canceled = stmt.getString(3);
	    System.out.println("@canceled = " + canceled);
            String resolved = stmt.getString(4);
	    System.out.println("@resolved = " + resolved);
            String disputed = stmt.getString(5);
	    System.out.println("@disputed = " + disputed);
