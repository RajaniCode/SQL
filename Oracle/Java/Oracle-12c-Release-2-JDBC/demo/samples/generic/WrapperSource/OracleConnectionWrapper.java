...
public class OracleConnectionWrapper implements oracle.jdbc.OracleConnection
{
   ...
   * @param wrapper
   * @see oracle.jdbc.OracleConnection.getJavaSqlConnection oracle.jdbc.OracleConnection.getOracleConnection
   */
  ...
  public void startup(DatabaseStartupMode mode, String pfileName) throws SQLException {
    connection.startup(mode, pfileName);
  }
   ...
   * @since 11R1
   */
  public oracle.sql.TIMESTAMP createTIMESTAMP(java.sql.Date value) 
    throws SQLException
  {
   ...
   * @since 11R1
   */
  public oracle.sql.TIMESTAMP createTIMESTAMP(oracle.sql.DATE value) 
    throws SQLException
  {
    return connection.createTIMESTAMP(value);
  }
   ...
   * @since 11R1
   */
  public oracle.sql.TIMESTAMP createTIMESTAMP(java.sql.Time value) 
    throws SQLException
  {
    return connection.createTIMESTAMP(value);
  }
   ...
   * @since 11R1
   */
  public oracle.sql.TIMESTAMP createTIMESTAMP(java.sql.Timestamp value) 
    throws SQLException
  {
    return connection.createTIMESTAMP(value);
  }
  ...
  public oracle.sql.TIMESTAMP createTIMESTAMP(java.sql.Timestamp value,
    ...
    throws SQLException
  {
    return connection.createTIMESTAMP(value, cal);
  }
   ...
   * @since 11R1
   */
  public oracle.sql.TIMESTAMP createTIMESTAMP(String value) 
    throws SQLException
  {
    return connection.createTIMESTAMP(value);
  }
  ...
  /**
   * Creates a new TIMESTAMPTZ with the given value. 
   * The value is interpreted in the time zone of the calendar.
   *
   * @param value the value that the new object should represent
   * @param cal the timezone of the value
   * @return a new TIMESTAMPTZ
   ...
   *
   * @param value the value that the new object should represent
   * @param tzid the ZoneId of the value
   * @return a new TIMESTAMPTZ
   * @throws SQLException if a database error occurs
   * @since 11R1
   */
  public oracle.sql.TIMESTAMPTZ createTIMESTAMPTZ(java.sql.Timestamp value, 
    ...
    throws SQLException
  {
    return connection.createTIMESTAMPTZ(value, tzid);
  }
   ...
   * @since 11R1
   */
  public oracle.sql.TIMESTAMPTZ createTIMESTAMPTZ(oracle.sql.DATE value) 
    throws SQLException
  {
    return connection.createTIMESTAMPTZ(value);
  }
  ...
  public boolean isWrapperFor(Class<?> iface) throws SQLException {
    if (iface.isInterface())
      ...
      throw (SQLException)(DatabaseError.createSqlException(null, DatabaseError.EOJ_DOES_NOT_WRAP_INTERFACE).fillInStackTrace());
    }
  }
...
m4_ifInServer({:
        return sun.reflect.misc.MethodUtil.invoke(method, wrapper, args);
:},{:
...
m4_ifInServer({:
        return sun.reflect.misc.MethodUtil.invoke(method, wrapper.connection, args);
:},{:
...
:})
  ...
  protected <T> T proxyFor(Object obj, Class<T> iface) throws SQLException{
    ...
    try {
      ...
      throw (SQLException)(DatabaseError.createSqlException(null, DatabaseError.EOJ_ERROR, "Cannot construct proxy").fillInStackTrace());
    }
  }
  ...
  public <T> T unwrap(Class<T> iface) throws SQLException {
    if (iface.isInterface()) {
      ...
      else return (proxyFor(connection.unwrap(iface), iface));
    }
    else {
      throw (SQLException)(DatabaseError.createSqlException(null, DatabaseError.EOJ_DOES_NOT_WRAP_INTERFACE).fillInStackTrace());
    }
 ...
 @Override
   ...
   * @return true if DRCP multitagging is enabled.
   * @see #CONNECTION_PROPERTY_USE_DRCP_MULTIPLE_TAG
   * @throws SQLException
   */
  ...
  /**
   * Returns the tag associated with this DRCP pooled server. If multiple tags are
   * used, they will be separated by a semicolon. If tagging is not enabled or not
   * available or if this connection is currently not attached to any DRCP pooled
   * server then this method returns null.
   * @see #detachServerConnection(java.lang.String)
   * @see #CONNECTION_PROPERTY_USE_DRCP_MULTIPLE_TAG
   * @throws SQLException
   */
   ...
   * @see #CONNECTION_PROPERTY_DRCP_PLSQL_CALLBACK
   * @see #CONNECTION_PROPERTY_USE_DRCP_MULTIPLE_TAG
   * @throws SQLException
   */
  ...
  @Override
  public void setShardingKey(OracleShardingKey key, OracleShardingKey superKey) 
      throws SQLException {
    connection.setShardingKey(key, superKey);
  }
  
  @Override
  public boolean setShardingKeyIfValid(OracleShardingKey key, OracleShardingKey superKey, int timeout) 
    throws SQLException {
    return connection.setShardingKeyIfValid(key, superKey, timeout);
  }
...
/*
 * MODIFIED      (MM/DD/YY)
 * tzhou       01/07/14 - 17790513: added request boundary APIs
...
/**
 * @version $Header: dbjava/src/java/oracle/jdbc/OracleConnectionWrapper.java /main/68 2016/01/19 09:02:31 igarish Exp $
 * @author  eshirk
 * @since   9.2
 */
