// java -cp "PostgreSQL-JDBC\postgresql-42.2.5.jar;.;" PostgreSQLFunctionSp
// OR
...
public class PostgreSQLFunctionSp { 
    public static void main(String args[]) {                
        PostgreSQLFunction postgreFunction = new PostgreSQLFunction();
        StringBuilder query = new StringBuilder();
        // query.append("SELECT sp(?);");
        query.append("SELECT * FROM sp(?);");        
        Map<Integer, Object> params = new HashMap<Integer, Object>(); 
        params.put(1, 6);
        // int[] resultRowNumbers = new int[] { 1 }; //
        int[] resultRowNumbers = new int[] { 1, 2, 3, 4 };        
