// java -cp "PostgreSQL-JDBC\postgresql-42.2.5.jar;.;" PostgreSQLFunctionProcs
// OR
...
public class PostgreSQLFunctionProcs { 
    public static void main(String args[]) {                
        ...
        query.append("SELECT * FROM concat(?, ?);");
        params = new HashMap<Integer, Object>(); 
        params.put(1, "My");
        params.put(2, "SQL");

        resultRowNumbers = new int[] {1};
        outParams = postgreFunction.getOutParams(query.toString(), params, resultRowNumbers);
        if(outParams != null) {
            for(Entry<Integer, Object> outParamsEntry : outParams.entrySet()) {        	
                System.out.println(outParamsEntry.getValue());
            }
