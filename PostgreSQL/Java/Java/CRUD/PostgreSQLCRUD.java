// java -cp "PostgreSQL-JDBC\postgresql-42.2.5.jar;.;" PostgreSQLCRUD
// OR
...
class DataAccessObject {
    // private final String url = "jdbc:postgresql://localhost:3306/spdb?user=postgres&password=PostgreSQL-10.5-1&useSSL=false";
    // private final String url = "jdbc:postgresql://localhost:3306/spdb?useSSL=false";
...
class CRUD { 
    public int dropTableIfExists() {
        ...
        dropQuery.append("DROP TABLE IF EXISTS actor2;"); 
    ...
    public int createTableLike() {
        ...
        createQuery.append("CREATE TABLE actor2 (LIKE actor INCLUDING ALL)");     
    ...
    public int insertTable() {
        ...
        insertQuery.append("INSERT INTO actor2 SELECT * FROM actor;");         
