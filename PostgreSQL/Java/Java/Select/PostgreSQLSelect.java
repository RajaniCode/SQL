// java -cp "PostgreSQL-JDBC\postgresql-42.2.5.jar;.;" PostgreSQLSelect
// OR
...
public class PostgreSQLSelect { 
    public static void main(String args[]) {                
        PostgreSQLData postgreData = new PostgreSQLData();
        ...
        Map<Integer, Map<String, String>> rows = postgreData.getData(selectQuery.toString());
        if (rows != null) {
