...
try {
    ...
    foreach($rows as $row) {
        if (php_sapi_name() == 'cli') { // To be verified with Apache
            echo $row['username'] . " " . $row['login_date'] . " " . $row['login_time'] . " " . $row['created_at'] . " " . $row['updated_at'] . "\n";
        } else {
            echo "<br/>" . $row['username'] . " " . $row['login_date'] . " " . $row['login_time'] . " " . $row['created_at'] . " " . $row['updated_at'] . "<br/>";
        }
    }
