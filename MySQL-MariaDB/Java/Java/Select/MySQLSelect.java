// java -cp "MySQL-JDBC\mysql-connector-java-8.0.12.jar;.;" MySQLSelect
// OR
// export CLASSPATH="MySQL\Java\MySQL-JDBC\mysql-connector-java-8.0.12.jar;.;"
// echo $CLASSPATH
// OR
...
class DataAccessObject {
    ...
    // useSSL=false
    // private final String url = "jdbc:mysql://localhost:3306/spdb?user=root&password=My$ql@Server#8.0.12&useSSL=false";
    // private final String url = "jdbc:mysql://localhost:3306/spdb?useSSL=false";
...
public class MySQLSelect { 
    public static void main(String args[]) {                
        MySQLData myData = new MySQLData();
        ...
        Map<Integer, Map<String, String>> rows = myData.getData(selectQuery.toString());
        if (rows != null) {
