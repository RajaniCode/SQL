// java -cp "MySQL-JDBC\mysql-connector-java-8.0.12.jar;.;" MySQLSpIn
// OR
...
public class MySQLSpIn {
    public static void main(String args[]) {                
	    ...
	    while (rs.next()) {
                // customer_id, customer_name, email, date_of_birth, income, credit_limit, create_date, last_update
                /*
		System.out.println(String.format("%-10d%-20s%-30s%-20tF%-20.2f%-10.2f%-20tF%tF",
