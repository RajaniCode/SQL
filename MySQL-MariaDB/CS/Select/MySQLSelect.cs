...
// csc MySQLSelect.cs /reference:"E:\Working\SQL\MySQL\CS\MySql.Data.6.9.9\lib\net45\MySql.Data.dll"
...
class Program
{
	...
	//dao.TestConnection();
        ...
        //selectQuery.Append("SELECT * FROM customers;");
        //selectQuery.Append("SELECT * FROM customers ORDER BY customerNumber DESC LIMIT 2;");
        selectQuery.Append("SELECT customerNumber, customerName, contactLastName, contactFirstName, phone, addressLine1, addressLine2, city, state, postalCode, country, salesRepEmployeeNumber, creditLimit FROM customers;");
        //selectQuery.Append("SELECT customerNumber, customerName, contactLastName, contactFirstName, phone, addressLine1, addressLine2, city, state, postalCode, country, salesRepEmployeeNumber, creditLimit FROM customers ORDER BY customerNumber DESC LIMIT 2;");
