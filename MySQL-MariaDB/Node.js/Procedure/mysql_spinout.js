...
connection.connect(function(err) {
  ...
  var query = connection.query("CALL spinout(200, @out_count);", post, function(err, results) {
    //console.log(results);
    var inner_query = connection.query("SELECT @out_count;", post, function(inner_query, inner_results) {
