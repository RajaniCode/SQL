...
connection.connect(function(err) {
  ...
  var query = connection.query("CALL spinputoutput(103, @level);", post, function(err, results) {
    //console.log(results);
    var inner_query = connection.query("SELECT @level;", post, function(inner_query, inner_results) {
