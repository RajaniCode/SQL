...
connection.connect(function(err) {
  ...
  var query = connection.query("CALL sp(141, @shipped, @canceled, @resolved, @disputed);", post, function(err, results) {
    //console.log(results);
    var inner_query = connection.query("SELECT @shipped, @canceled, @resolved, @disputed;", post, function(inner_query, inner_results) {
